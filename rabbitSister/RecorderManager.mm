...
//    self.encapsulator.delegete = self;
    ...
    self.timerTimeout = [NSTimer scheduledTimerWithTimeInterval:timeOut target:self selector:@selector(timeoutCheck:) userInfo:nil repeats:NO];
}
