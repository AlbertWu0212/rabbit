...
//    Notification__POST(OVERGETSPEAK,nil);
}
...
//    NSBubbleData *data = [[self.bubbleSection objectAtIndex:indexPath.section] objectAtIndex:indexPath.row - 1];
    ...
    NSBubbleData *data = [[self.bubbleSection objectAtIndex:indexPath.section] objectAtIndex:indexPath.row/2];
...
//        NSBubbleData *data = [[self.bubbleSection objectAtIndex:indexPath.section] objectAtIndex:0];
        ...
        cell.label.text=[delegates.speakerTimeArr objectAtIndex:indexPath.row/2];
...
//    NSLog(@"嘻嘻：%@",data.avatar);
    ...
    if ([cell.data.view isKindOfClass:[UILabel class]]) {
...
//    NSLog(@"456");
    if (scrollView.contentOffset.y<45) {
        Notification__POST(GETHISTORYSPEAK,nil);
    }
}
...
//    NSLog(@"草：%f",scrollView.contentOffset.y);
